...
function FeaturedWork() {
  return (
    <div className="w-full py-20 flex flex-col items-center text-white">
      <h2 className="text-[48px] uppercase">Featured Work</h2>
      ...
      <div className="w-10/12 py-10 grid grid-cols-4 relative">
        ...
        <span className="w-full mt-5 flex justify-end items-start ">
        ...
        <span className="w-full col-span-2 -mt-32 flex justify-center">
          <img src={art} alt="" className="w-[90%]" />
        </span>

        <span className="w-full row-span-2 -mt-20">
